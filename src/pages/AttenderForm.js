...
import "../styles/AttenderForm.css";

const AttenderRegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    link.download = "attender_registration_form.csv";
    link.click();
  };

  return (
    <form className="attender-form" onSubmit={handleSubmit}>
      <h2>Attender Registration</h2>
